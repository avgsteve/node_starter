...
console.log("Current website path: ", currentURLPath); // Intialize Materialize Components

window.addEventListener('load', function (event) {}); // All the startup functions/applications to be loaded after browser finishes loading

document.addEventListener('DOMContentLoaded', function () {
  console.log('document is loaded');
});
var alertMessage = $('.alert__test');
$('.show_alert').on('click', function () {
  alertMessage.fadeIn();
  closeSnoAlertBox(alertMessage);
});
var alertMessag2 = $('.alert__test2');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14414" + '/');
